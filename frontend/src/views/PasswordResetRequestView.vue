      ...
      <div class="reset-password-card">
          ...
          <form @submit.prevent="handleResetRequest">
            ...
            <div class="form-field">
              ...
              <div class="p-input-icon-left w-full flex-row">
            ...
            <div v-if="identificationType.value === 'cni'" class="form-field">
            ...
            <div v-if="identificationType.value === 'cne'" class="form-field">
