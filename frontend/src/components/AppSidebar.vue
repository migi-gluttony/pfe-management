  ...
  <aside v-if="isAuthenticated" class="app-sidebar">
    <div class="sidebar-content">
      ...
      <div class="sidebar-logo">
        <img src="@/assets/pfe_man_logo_whole_final.svg" alt="EST FBS Logo" />
      </div>

      <!-- Custom menu instead of PrimeVue Menu -->
      <div class="sidebar-menu">
        ...
        >
          ...
          <i v-if="item.hasSubmenu" class="pi pi-chevron-down submenu-icon"></i>
        </div>
      </div>
