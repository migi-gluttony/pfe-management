        ...
        <div class="col-12 md:col-6 lg:col-3">
          <div class="dashboard-card">
            ...
            <div class="card-content">
              ...
              <Button label="Manage Users" icon="pi pi-arrow-right" class="p-button-sm" @click="navigateTo('/hod/users')" />
            </div>
          </div>
        </div>
        ...
        <div class="col-12 md:col-6 lg:col-3">
          <div class="dashboard-card">
            ...
            <div class="card-content">
              ...
              <p>View and manage all final year projects.</p>
              <Button label="View Projects" icon="pi pi-arrow-right" class="p-button-sm" @click="navigateTo('/hod/projects')" />
            </div>
          </div>
        </div>
        ...
        <div class="col-12 md:col-6 lg:col-3">
          <div class="dashboard-card">
            ...
            <div class="card-content">
              ...
              <Button label="View Reports" icon="pi pi-arrow-right" class="p-button-sm" @click="navigateTo('/hod/reports')" />
            </div>
          </div>
        </div>
        ...
        <div class="col-12 md:col-6 lg:col-3">
          <div class="dashboard-card">
            ...
            <div class="card-content">
              ...
              <Button label="Settings" icon="pi pi-arrow-right" class="p-button-sm" @click="navigateTo('/hod/settings')" />
            </div>
          </div>
        </div>
      </div>
