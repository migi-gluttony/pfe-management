<template>
    <div class="evaluation-sheet print-only">
      ...
      <div class="student-info">
        ...
        <div class="info-row">
          <div class="info-field">
            <span class="field-label">Nom & Prénom de l'étudiant:</span>
            <span class="field-value">{{ student.nom }} {{ student.prenom }}</span>
          </div>
        </div>
        
        <div class="info-row">
          <div class="info-field">
            <span class="field-label">Titre du:</span>
        ...
        <div class="info-row">
          <div class="info-field">
            ...
            <span class="field-value">_____________________</span>
          </div>
          
          <div class="info-field">
            <span class="field-label">à</span>
            <span class="field-value">_________</span>
          </div>
        </div>
