...
public class BinomeManagementService {
        ...
        /**
         * Get binomes, filieres, available students, encadrants and subjects for the
         * current year
         */
                ...
                if (filiereId != null) {
                        ...
                        Filiere filiere = filiereRepository.findById(filiereId)
                                        .orElseThrow(() -> new RuntimeException(
                                                        "Filière non trouvée avec l'id: " + filiereId));
                        ...
                        // Get binomes where at least one student is from this filiere AND binome is for
                        // current year
                ...
                if (request.getEtudiant2Id() != null) {
                        ...
                        if (binomeRepository.findAll().stream()
                                        ...
                                        .anyMatch(b -> b.getEtudiant1().equals(etudiant2) ||
                                                        (b.getEtudiant2() != null
                                                                        && b.getEtudiant2().equals(etudiant2)))) {
                                throw new RuntimeException(
                                                "L'étudiant 2 fait déjà partie d'un binôme pour l'année courante");
                        }
                } else {
                        etudiant2 = null;
                }
