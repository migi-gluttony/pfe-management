...
public class SujetSelectionService {
    ...
    public SujetSelectionResponse getAvailableSujets(Long etudiantId) {
        ...
        StudentDTO etudiant2DTO = binome.getEtudiant2() != null ? 
                mapToStudentDTO(binome.getEtudiant2()) : null;
    ...
    public SujetDTO selectSujet(Long etudiantId, Long sujetId) {
        ...
        if (hasPendingSuggestion) {
            throw new RuntimeException("You have a pending sujet suggestion. Wait for a response before choosing a sujet");
        }
