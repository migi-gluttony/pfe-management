...
public class NoteManagementController {
     ...
     */
    @GetMapping("/student/{etudiantId}/details")
    public ResponseEntity<NoteDetailDTO> getNoteDetails(@PathVariable Long etudiantId) {
        return ResponseEntity.ok(noteManagementService.getNoteDetailsForStudent(etudiantId));
    }
}